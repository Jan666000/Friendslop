...
namespace Friendslop 
{
    public class SteamLobby : NetworkBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("Steam did not initialize. Run the game through Steam.");
                return;
            }
        ...
        void OnLobbyCreated(LobbyCreated_t callback) 
        {
            ...
            {
                Debug.LogError("Failure to create lobby: " + callback.m_eResult);
                return;
            }

            Debug.Log("Lobby created succesfully" + callback.m_ulSteamIDLobby);
        ...
        void OnGameLobbyJoinRequested(GameLobbyJoinRequested_t callback) 
        {
            ...
            {
                Debug.Log("Client is active or connected. Disconnecting before joining new lobby");
        ...
        void OnLobbyEntered(LobbyEnter_t callback)
        {
            ...
            lobbyID = callback.m_ulSteamIDLobby;
            string _hostAdress = SteamMatchmaking.GetLobbyData(new CSteamID(callback.m_ulSteamIDLobby), HostAddressKey);
        ...
        private IEnumerator DelayedNameUpdate(float delay) 
        {
            ...
            {
                Debug.Log("LobbyUIManager.Instance equals null, skipping name update");
                yield break;
            }
